...
wildhell_2019 <- read.csv("WildHell_2019_traits.csv")
wildhell_2022 <- read.csv("2022_WildHellTraits_Original.csv")
...
wildhell_2022_updated <- read.csv("wildHellTraits2022.csv")
...
stem_density <- read.csv("height_2022.csv")

unique(stem_density$species) # No species typos
