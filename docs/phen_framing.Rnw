...
spp_sigma <- sigma_draws %>%
  mean_hdi(sd_spp__Intercept, .width = 0.95)
...
yr_sigma <- sigma_draws %>%
  mean_hdi(sd_year__Intercept, .width = 0.95)
...
pop_sigma <- sigma_draws %>%
  mean_hdi(sd_site__Intercept, .width = 0.95)
...
yr_sigma_gs <- sigma_draws_gs %>%
  mean_hdi(sd_year__Intercept, .width = 0.95)
gs.sig.yr<-round(yr_sigma_gs[1],2)
