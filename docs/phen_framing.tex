...
%emwNov4 -- START BELOW! Need to merge results and discussion .... 
...
\section{Discussion}
%emwNov4 -- moved this down from previous spot in intro, but have not adjusted text yet!
...
%emwNov4 -- end of: moved this down from previous spot in intro, but have not adjusted text yet!
