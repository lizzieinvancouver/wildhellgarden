...
\end{figure}
 ...
 \includegraphics[width=.8\textwidth]{..//analyses/figures/sup2.pdf}
    \caption{Difference in leafout, leaf coloration and growing season length partitioned between populations (a) and years (b). Point represent the median effect size estimate, and thick and thin bars the 50\% and 90\% uncertainty intervals.}
    \label{fig:alta}
\end{figure}
