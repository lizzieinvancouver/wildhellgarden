...
\section{Figures}
 ...
 \includegraphics[width=.8\textwidth]{..//analyses/figures/full_var_parts.jpeg}
    \caption{Difference in leafout, leaf coloration and growing season length partitioned between species (a) populations (b) and years (c). Point represent the median effect size estimate, and bars the 90\% uncertainty intervals.}
    \label{fig:alta}
\end{figure}
