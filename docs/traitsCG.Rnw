...
\begin{enumerate}
\item Variation due to sppecies is much greater than pop
\item  Harvard forest has a negative population effect - most souther
\item St. Hippolyte (most northern) is positive, but Grant has the largest population effect
...
\begin{enumerate}
\item variation due to population is twice as great as species
\item There are no strong differences across populations, but estimate is oddly large
\item Spitom has the largest positive species effect, Vibcas the most negative
...
\begin{enumerate}
\item variation due to sppecies is much greater than pop, about three times
\item  Harvard forest and white mountain are positive (the two more southern sites)
\item but grant has a much stronger negative effect than St. Hippolyte
...
\begin{enumerate}
\item variation due to sppecies is still much greater than pop
...
\begin{enumerate}
\item variation due to sppecies is much greater than pop; but values are very small
\item  Population estimates are essentailly 0
...
\begin{enumerate}
\item Variation due to sppecies is much greater than pop, about four times
